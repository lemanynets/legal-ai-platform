...
import type { CaseLawSearchItem } from "../api"; // Тимчасовий імпорт типу зі старого файлу
...
export async function updateCase(caseId: string, payload: Partial<Case>, token?: string, demoUser?: string): Promise<Case> {
